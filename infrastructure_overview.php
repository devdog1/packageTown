...
<head>
    ...
    <title>Detailed Infrastructure Overview</title>
...
$packages = read_csv('speed_packages.csv');
$profiles = read_csv('profiles.csv');
$profile_package_mappings = read_csv('profile_package_mapping.csv');
$node_profile_mappings = read_csv('node_profile_mapping.csv');
